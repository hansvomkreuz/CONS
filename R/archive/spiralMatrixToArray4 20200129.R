...
spiralMatrixToArray4 <- function(gclData, eyeCenter){
    ...
    for(i in 1:totalSides){
        ...
        if (i == 1){
            cat("currentC:",currentC,"- currentR: ",currentR,"\n")
            arrayData <- as.integer(gclData[currentR,currentC])
            currentC <- currentC + elements
            cat("UPDATE: currentC:",currentC,"- currentR: ",currentR,"\n")
        } else if (i %% 4 == 1){
            if(between(currentR,1,maxR)){
                ...
                cat("currentC:",currentC,"- currentR:",currentR,"startC:",startC,"- endC:",endC,"\n")
            ...
            if(between(currentC,1,maxC)){
                ...
                cat("currentC:",currentC,"- currentR:",currentR,"startR:",startR,"- endR:",endR,"\n")
            ...
            cat("BEFORE UPDATES: currentC:",currentC,"- currentR:",currentR,"\n")
            if(between(currentC,1,maxC)){
                if(currentR < 1){
                    startR <- 1
